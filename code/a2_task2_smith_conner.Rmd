...
This analysis uses non linear least squares to estimate parameters of a length to weight model for lizard populations in New Mexico. It first estimates a model based on the entire data set including both male and female lizards across 13 species. The analysis then estimates a model specific to the Western Whiptail lizard (*Cnemidophorus tigrisatus*) and comapres the predictive accuracy of the species-specific model to the general model.
...
## **Species-Specific Model Comparisson**
...
The results of the mdoel comparisson show that the model attuned specifically to the male Western Whiptail lizards does a better job at predicting their actual weights than the generalized model trained on the entire data set. 
